...
$query=mysqli_query($db_connect, "SELECT * FROM subservices")or die (mysqli_error());
...
<tbody>
  ...
  <tr> 
    ...
    <td>
      <a href="editsubservices.php?id=<?php echo $row['service_id'];?>">
        <span class="btn btn-success bg-green">
          <i class="fa fa-edit"></i> Edit 
        </span>
      </a>
      <a href="subdelete.php?id=<?php echo $row['service_id'];?>">
