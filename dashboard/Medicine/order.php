...
$table_order = ($_SESSION['branch'] == "Baranggay"? "medicines_hc" : "medicines_brgy");
...
if(isset($_POST['order'])) { 
  ...
  if($result->num_rows == 0) {
    ...
    <script type="text/javascript">
      setTimeout(function() {
        swal({
          title: "Medicine Ordered Successsfully",
          icon: "success",
          button: "Ok",
        })
      }, 200);
...
<div class="content-wrapper">
  <section class="content-header">
   ...
   <ol class="breadcrumb">
    ...
    <li class="active">Order Medicine</li>
  </ol>
</section>
<section class="content">
  <div class="box">
    <div class="box-header with-border">
      <h2 class="box-title">Order Medicine</h2>
    </div>
