...
{ 
    ...
    $username=$_POST['username'];
      ...
      $write =mysqli_query($db_connect, "UPDATE login SET fname='$fname',lname='$lname',username='$username',password='$passwordP'") or die(mysqli_error());
      //$query=mysqli_query($db_connect, "SELECT * FROM user ")or die (mysqli_error());
