...
$user= $_SESSION['username'];
	...
	$queryget=mysqli_query($con, "SELECT password FROM login WHERE username='$user'") or die (mysqli_error($db_connect));
...
//echo $oldpassword ."<br>";
	...
	if($oldpassword==$oldpassworddb)
	{
		...
		{
			//echo"Success!";
			$querychange=mysqli_query($con, "UPDATE login SET password='$newpassword' WHERE username='$user'");
		session_destroy();
